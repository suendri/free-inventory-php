...
$(document).ready(function(){
   $("#kdPms").keyup(function(){
		// tampilkan akdPmsasi loading saat pengecekan ke database
...
if ((isset($_POST["MM_insert"])) && ($_POST["MM_insert"] == "form1")) {
  $insertSQL = sprintf("INSERT INTO pbpemasok (kode, nama, alamat, telp, kota, tgl_masuk) VALUES (%s, %s, %s, %s, %s, %s)",
                       GetSQLValueString($_POST['kdPms'], "text"),
  ...
  <table class="table table-hover">
    <tr>
      ...
      <td><span id="sprytextfield1">
        <input type="text" class="form-control" name="kdPms" value="" size="32" id="kdPms" placeholder="Kode Pemasok" required=""/>
    ...
    <tr>
      ...
      <td><span id="sprytextfield2">
        <input class="form-control" type="text" name="nama" value="" size="32"  placeholder="Nama Pemasok" required=""/>
    ...
    <tr>
      ...
      <input class="btn btn-primary" type="button" name="kembali" id="kembali" value="Kembali" onClick="location='page.php?modul=show_pms'"/></td>
    </tr>
  </table>
